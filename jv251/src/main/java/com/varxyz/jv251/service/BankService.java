...
public class BankService {
	...
	public static final double DEFAULT_INTEREST_BATE = 0.03;
	...
	public void addCustomer(String name, String ssn, String phone, String userId, String passwd) {
		if (!isCustomer(ssn)) {
			...
			throw new DuplicatedEntityException(ssn + "is duplivated.");
		}
	}
	...
	public void addSavigsAccount(double balance, double interestRate, String ssn) throws CustomerNotFoundException {
		SavingsAccount account = new SavingsAccount();
		account.setAccountNum(accountService.generateAccountNum());
		account.setBalance(balance);
		account.setAccountType(BankService.SA);
		account.setIntersetRate(interestRate);
